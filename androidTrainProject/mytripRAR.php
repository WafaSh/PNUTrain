...
if($arrival==8){echo "<div class=\"line\">"; print_route($sqlF); echo "- A8 </div>";}
else if($arrival==9){echo "<div class=\"line\">";  print_route($sqlF); echo " - A8 </div></div><br> :التالي<br><div class=\"line\"  style=\"color:blue\"المسار الأزرق</Div><br> <div class=\"line\"> A8 - A9 </div> <br>";}
else if($arrival==10){echo "<div class=\"line\">"; print_route($sqlF); echo " - A8 </div><br> :التالي<br><div class=\"line\"  style=\"color:blue\">المسار الأزرق</Div><br><div class=\"line\">  A8 - A9 - A10</div>  <br>";}
else if($arrival==1){echo "<div class=\"line\">"; print_route($sqlF); echo " - A8</div> <br> :التالي <br><div class=\"line\"  style=\"color:blue\">المسار الأزرق</Div><br><div class=\"line\" > A8 - A9 - A10 - A1</div> <br>";}
else if($arrival==2){echo "<div class=\"line\">"; print_route($sqlF); echo " - A8</div> <br> :التالي <br><div class=\"line\" style=\"color:blue\">المسار الأزرق</Div><br><div class=\"line\" > A8 - A9 - A10 - A1 - A2 </div><br>";}
	...
	echo "<div class=\"line\">";
	print_route($sqlF);
	echo " - A8</div> <br> :التالي<br><div class=\"line\" style=\"color:red \">المسار الأحمر</Div> <br><div class=\"line\"> - A8 - A7 - A6 - A5 ";
    print_route($sqlS_);
	echo "</div>";
}
  ...
  $sql2="SELECT station_name FROM station where station_id <=$arrival AND station_id>10 ORDER BY station_id ASC ";
   ...
   print_route($sql);
	...
	echo "<br><div class=\"line\" style=\"color:red \">المسار الأحمر</Div> <br><div class=\"line\">";
    $sql="SELECT station_name FROM station where station_id >=$departure AND  station_id<15 ORDER BY station_id ASC ";
    print_route($sql);
    echo " - A4 </div><br> :التالي<br><div class=\"line\" style=\"color:green \">المسار الأخضر</Div><br><div class=\"line\"> - A4 - A3 - A2 - A1 - A10 - A9 "; 
	print_route($sql2);
	   echo"</div>";
   }
   ...
   print_route($sql);
    echo "</div><br> :التالي<br><div class=\"line\" style=\"color:green\">المسار الأخضر</Div><br><div class=\"line\"> - A9 "; 
	  print_route($sql2);
	  echo "</div>";
   }
...
echo "</div>";}
	...
	echo "<div class=\"line\">";
	print_route($sqlS);
	echo " -A4</div> <br> :التالي<br><div class=\"line\" style=\"color:blue\">المسار الأزرق</Div> <br><div class=\"line\"> - A4 ";
    print_route($sqlS_);
	echo "</div>";
}
}
...
if($arrival==13 || $arrival==14){ //IF Arrival is ---S1 OR S2 ---
 ...
 $sql2="SELECT station_name FROM station where station_id >=$arrival AND station_id<15 ORDER BY station_id DESC ";
	...
	echo "<br><div class=\"line\" style=\"color:blue\">المسار الأزرق</Div><br>";
		echo "<div class=\"line\">";
		print_route($sql);
	echo "</div><br> :التالي<br><div class=\"line\" style=\"color:red \">المسار الأحمر</Div><br><div class=\"line\"> - A5  ";
	print_route($sql2); 
	echo "</div>";
}
...
/////////
// -------------------- Blue Line --------------------- //
if($departure==10 && $arrival==1){
	

echo "<br> <div class=\"line\" style=\"color:blue\">المسار الأزرق</Div><br><div class=\"line\"> - A10 - A1 </div>";	

}
if($departure>1 && $departure<4  && $arrival<11 && $arrival>7){
...
$sql2="SELECT station_name FROM station where station_id >=$arrival AND station_id<11 ORDER BY station_id DESC";
echo "<br> <div class=\"line\" style=\"color:#800080\">المسار الأرجواني</Div><br><div class=\"line\"> - A1 ";	
print_route($sql2);	
echo "</div>";	
}
...
echo "</div>";	
	...
	echo "Your Departure and Arrival Station Are Same, Plase Select Stations Again";
}
